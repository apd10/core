...
class RushLSH:
    def __init__(self, dimension, r, l, k, to_vector=None, get_x_id=None):
        ...
        self.K = k
        self.N = 0
        self.sketch = np.zeros((l, r, 0, dimension))
    ...
    def __insert_to_sketch(self, i, h, x_vector):
        self.sketch[i, h] = np.append(self.sketch[i, h], [x_vector])
    ...
    def __get_bucket_contents(self, i, h, x_vector):
        self.query_results.extend(self.sketch[i, h])
